      ...
      <div className="max-w-screen-xl space-y-8 lg:space-y-8 mx-auto">
        <div className="grid grid-cols-1 px-4 sm:px-6 py-16 gap-8 lg:px-16 lg:grid-cols-3">
          ...
          <div>
            ...
            <ul className="mt-5 flex gap-3">
              {socialLinks.map((item) => (
                <li key={item.name} className="bg-[#BDC4CD] p-1 rounded-full">
                  <a
                    href={item.href}
                    rel="noreferrer"
                    target="_blank"
          ...
          <div className="grid grid-cols-1 gap-8 sm:grid-cols-2 lg:col-span-2 lg:grid-cols-5">
            ...
            {/* Get App Section */}
            <div>
              <p className="font-medium text-gray-900">Get App</p>
              <div className="mt-3 flex flex-col  gap-3">
                {getApp.map((app, idx) => (
                  <Link
                    ...
                    className="bg-black w-[130px] h-[42px] rounded flex items-center justify-center"
                  >
                    <img
                      src={app.image}
                      alt={app.alt}
                      className="w-[100px] h-auto rounded shadow hover:opacity-80 transition"
                    />
                  </Link>
                ))}
              </div>
